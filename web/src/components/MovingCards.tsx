...
const testimonials: Testimonial[] = [
  {
    ...
    quote:
      "Book appointments hassle-free with CalSync. Patients easily schedule consultations with trusted doctors and therapists, enjoying the convenience of virtual visits from home.",
  },
  {
    image: employee,
    title: "Company → Candidate",
    quote:
      "Effortlessly schedule interviews and appointments with CalSync. Candidates seamlessly book interviews with potential employers, streamlining the hiring process for both parties.",
  },
  {
    image: teacher,
  ...
  },
  {
    ...
    quote:
      "Connect and collaborate effortlessly on CalSync. Experts mentor fellows while fellows book one-on-one meetings, fostering a supportive community for learning and growth.",
  },
];
